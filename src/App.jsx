...
const contentItems=[
  {title:"Three Published CVEs",type:"win",desc:"Three CVEs now credit us for real vulnerabilities we found in Gitea, File Browser, and OpenBao, software used by hundreds of millions. File Browser rated High. The OpenBao one came from watching a fixed Vault bug that still lived in the fork, and it just picked up its own CVE. Proof, not marketing.",link:"https://securva.net/research/disclosures",accent:"#FF6B6B"},
...
const projects=[
  ...
  {name:"Securva CVE Pipeline",desc:"Published CVEs credited to us: CVE-2026-27761 (Gitea), CVE-2026-55667 (File Browser, rated High), and CVE-2026-63131 (OpenBao, Moderate), with more in disclosure. Self-hosted OSS audits via incomplete-fix and cross-fork methodology, web2 and web3.",tech:["CVEs","Python","Methodology"],status:"Live",accent:"#FF6B6B"},
