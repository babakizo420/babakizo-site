...
const contentItems=[
  {title:"CVE-2026-16033: Canonical LXD and Incus",type:"win",desc:"Our advisory for an arbitrary host-file-write flaw in the LXC-family virtual-machine engine earned two CVE numbers, CVE-2026-16033 at Canonical LXD and CVE-2026-81497 at Incus, both credited to us. The same flaw was published by both Canonical (LXD) and the creator of Incus, rated High at CVSS 8.5. That sits alongside three published CVEs (File Browser rated High, OpenBao, and Gitea). Real vulnerabilities in software used by millions. Proof, not marketing.",link:"https://securva.net/research/disclosures",accent:"#FF6B6B"},
  {title:"Security Research (Open Source)",type:"research",desc:"Public repo: published CVE writeups, incomplete-fix tooling, and MCP / AI-agent security audits. The methodology, in the open.",link:"https://github.com/babakizo420/security-research",accent:"#7B68EE"},
...
const projects=[
  ...
  {name:"Securva CVE Pipeline",desc:"Published, credited to us: CVE-2026-27761 (Gitea), CVE-2026-55667 (File Browser, rated High), CVE-2026-63131 (OpenBao, Moderate), and a cross-fork arbitrary host-file-write flaw rated High at CVSS 8.5, credited across Canonical LXD (CVE-2026-16033) and Incus (CVE-2026-81497). More in disclosure. Self-hosted OSS audits via incomplete-fix and cross-fork methodology, web2 and web3.",tech:["CVEs","Incus","Methodology"],status:"Live",accent:"#FF6B6B"},
